...
| Repository | Purpose |
|------------|---------|
| 🔍 [**OFAC Crypto Screener**](https://github.com/sonmez-lab/ofac-crypto-screener) | Real-time OFAC sanctions screening for cryptocurrency addresses |
| 📊 [**FATF Compliance Dashboard**](https://github.com/sonmez-lab/fatf-compliance-dashboard) | Visual monitoring of FATF mutual evaluation compliance |
| 🇷🇺 [**Russia Sanctions Tracker**](https://github.com/sonmez-lab/russia-sanctions-tracker) | Automated tracking of Russia-related sanctions updates |
| 🇮🇷 [**Iran Sanctions Monitor**](https://github.com/sonmez-lab/iran-sanctions-crypto-monitor) | Cryptocurrency exposure analysis for Iran sanctions |
